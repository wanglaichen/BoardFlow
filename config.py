...
class AppConfig:
    ...
    FEDERATION_COMPARE_ENABLED = os.getenv("FEDERATION_COMPARE_ENABLED", "0")
    FEDERATION_COMPARE_TOKEN = os.getenv("FEDERATION_COMPARE_TOKEN", "")
    FEDERATION_ALLOWED_HOSTS = os.getenv("FEDERATION_ALLOWED_HOSTS", "")
    FEDERATION_ALLOW_PRIVATE_HOSTS = os.getenv("FEDERATION_ALLOW_PRIVATE_HOSTS", "0")
    COMPARE_SESSION_TTL_SEC = int(os.getenv("COMPARE_SESSION_TTL_SEC", "3600"))
    COMPARE_REMOTE_TIMEOUT_SEC = float(os.getenv("COMPARE_REMOTE_TIMEOUT_SEC", "30"))
    COMPARE_REMOTE_RETRY_COUNT = int(os.getenv("COMPARE_REMOTE_RETRY_COUNT", "2"))
    COMPARE_ACCOUNTS_PAGE_SIZE = int(os.getenv("COMPARE_ACCOUNTS_PAGE_SIZE", "20"))
    COMPARE_BOARDS_PAGE_SIZE = int(os.getenv("COMPARE_BOARDS_PAGE_SIZE", "20"))
    COMPARE_RESULTS_PAGE_SIZE = int(os.getenv("COMPARE_RESULTS_PAGE_SIZE", "20"))
